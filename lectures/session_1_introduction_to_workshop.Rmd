...
subtitle: "CPHRANN Workshop, Session 1"
...
I just finished my professional post graduate teaching course (adjunktpaedagogikum), so here is our contract for this workshop:

My part: _"At the workshop, you will be introduced to some of the underlying theory of artificial neural networks (ANNs), how an ANN model is created and we will discuss some of the pitfalls. Finally, you will get to implement, train, tune and apply an ANN based predictor."_

Your part:

 - Basic knowledge of the `R` programming language
 
 - Basic math skills equivalent to first year university course
 
 - An interest in learning more about neural networks

Teaching method:

 - Large class.
 
Since 120 people signed up, I have planned this as a large class workshop, meaning that I will not be able to go around and help you individually. I _highly_ encourage working in pairs for the exercises. Perhaps preferably with someone you do not know - These meetups are excellent networking opportunities!
...
- MSc in biotech engineering from DTU (Think lab coats, pipettes and goggles)

- PhD in bioinformatics from DTU (Bioinformatics of malaria vaccinology)

- Postdoc at Steno Diabetes Centre (Genetics of type I diabetes)

- Postdoc at Gentofte Hospital (Genetics of childhood asthma)

- Postdoc at DTU (Machine learning on molecular interactions)

- Assistant Professor of Bioinformatics at DTU (Machine learning on molecular interactions)
...
- An ANN can do both binary and multiclass classification and also regression (ANNs are universal approximators, more on this later)
