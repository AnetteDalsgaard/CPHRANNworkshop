...
subtitle: "CPHRANN Workshop, Session 3"
...
- But this only allows us to see the performance on one portion of the data
...
- Use the ensemble of 5 models to make new predictions by averaging over the 5 predictions
...
- In nested K-fold CV, with `k=5`, we use 3 sets for training (T, blue), 1 set for validation (V, green) and 1 set for early stopping (S, orange)

```{r, out.width = "500px", fig.align="center"}
knitr::include_graphics("figures/nested_k_fold_cv.png")
```
...
- Overfitting is a definite issue in deep learning (Be careful, this is the hallmark pitfall of ANNs!)
